...
const ProductFormDialog = ({ open, onClose, onCreated, businessId }: ProductFormDialogProps) => {
  const { user } = useAuth();
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-3 overflow-y-auto max-h-[70vh] no-scrollbar">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="text-xs font-medium text-muted-foreground mb-1 block">Barcode (auto)</label>
                  <input
