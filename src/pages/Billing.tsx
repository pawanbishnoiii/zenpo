...
const Billing = () => {
  ...
  return (
    <div className="lg:pl-20 h-screen flex flex-col lg:flex-row">
      ...
      {/* Cart Side (Desktop always visible, Mobile toggle) */}
      <div
        className={`lg:w-96 lg:border-l border-border bg-card flex flex-col ${
      ...
      >
        {showCart && (
          <button
            ...
            className="lg:hidden px-4 py-3 text-left text-sm font-semibold text-primary border-b border-border"
          >
            ← Back to Products
          </button>
        )}
