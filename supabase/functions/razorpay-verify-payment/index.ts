// Verifies a Razorpay payment signature (HMAC-SHA256) and marks the transaction paid.
// Called from the client after the Checkout popup success handler.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Fetch payment details from Razorpay for method/fee info
    ...
    return json({ ok: true, payment_id: razorpay_payment_id, txn: updated });
  } catch (e: any) {
